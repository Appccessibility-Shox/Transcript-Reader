...
const siteSpecificOptions = {
    ...
    * videoSource - (required) "embed" or "move". This will determine where the video in the reader comes from.
        ...
        - move: The video container that's on the site will be moved into the reader.
    ...
    * containerSelector - (optional. To be used when videoSource == "move". getVideoContainer() is used by default) a selector that, if provided, will be used as the video container.
